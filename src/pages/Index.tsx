    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="p-4 mb-6">
              <div className="flex items-center space-x-4">
                ...
                <button className="flex-1 text-left px-4 py-2 bg-white border border-gray-300 rounded-full text-gray-500 hover:bg-gray-50">
          ...
          <div className="lg:col-span-1">
            <Card className="p-4 mb-6">
              <h3 className="font-semibold text-gray-900 mb-4">Trending in Egypt</h3>
              <div className="space-y-4">
                {['Cairo Tech Week', 'Photography Exhibition', 'Digital Innovation', 'Egyptian Startups'].map((topic, index) => (
                  <div key={index} className="text-sm">
                    <p className="font-medium text-gray-900 hover:text-qudpro-primary cursor-pointer">
                      #{topic.replace(/\s+/g, '')}
                    </p>
                    <p className="text-gray-500 text-xs">{Math.floor(Math.random() * 1000) + 100} posts</p>
                  </div>
                ))}
              </div>
            </Card>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="text-sm">
                    ...
                    <p className="text-gray-500 text-xs">{Math.floor(Math.random() * 24) + 1}h ago</p>
                  </div>
                ))}
              </div>
            </Card>
